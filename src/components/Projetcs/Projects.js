                ...
                <div className="project-area p-5">
                    ...
                    <div className="row w-100">
                        <div className="col-md-6 pb-5">
                            ...
                            <a href="https://love-pet-81a10.firebaseapp.com/" target="_blank"><button className="live">Live</button></a>
                            <a href="" target="_blank"><button className="github">Github</button></a>
                            ...
                            <a href="https://city-riders-14374.firebaseapp.com/" target="_blank"><button className="live">Live</button></a>
                            <a href="" target="_blank"><button className="github">Github</button></a>
                        </div>
                        <div className="col-md-6">
                            <img src={HotOnion} alt="" className="img-fluid" />
                            <h3>Hot-Onion-Restaurant</h3>
                            ...
                            <a href="" target="_blank"><button className="live">Live</button></a>
                            <a href="" target="_blank"><button className="github">Github</button></a>
                            <img src={ITLatitude} alt="" className="img-fluid pt-5" />
                            <h3>IT-Latitude-Services</h3>
                            <p style={{color:'#B0B0B0'}}>A complete website where you can book appointments for your pets. You can also give your honest reviews through this website</p>
                            <a href="http://itlatitude.freehackgames.com/" target="_blank"><button className="live">Live</button></a>
                            <a href="" target="_blank"><button className="github">Github</button></a>
                        </div>
                    </div>
                </div>
